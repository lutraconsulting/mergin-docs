...
Another method which is suitable for sharing with a large number of users is to send them a link to your private project. If a user does not have access to the project, there will be a button to request access:
